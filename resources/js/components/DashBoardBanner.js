...
const DashBoardBanner = (props) => {
    ...
    //         // cut off range
    //         if(third_time.isAfter(second_afterTime)){
    //              setCutOff_Range(moment(third_beforeTime).format('hh:mm:ss A')+' - '+moment(thid_afterTime).format('hh:mm:ss A'));
    //         }
                ...
                <div className="relative">
                    ...
                    <p>
                        <span className="bold uppercase">
                            {props.cut_off.drawdate}
                        </span><br/>
                        CUTOFF TIME {props.cut_off.cutofftime}<br/>
                        {date}<br/>
                    </p>
                    <div className={props.disable?'hidden': "absolute bet-status right-align blink"}>
                        {
                            props.cut_off.cutoffdraw?
