...
class LiveTrendsSwer2 extends React.Component{
    ...
    asyncCall(){
        Axios.get('api/summary_grid/swer2', {
        ...
        // getCutoff
        Axios.get('api/get_cutoff/swer2',{
            cancelToken: new CancelToken(function executor(c) {
                // An executor function receives a cancel function as a parameter
                cancel = c;
              })
        ...
        // Player Stat
        Axios.get('api/player_stat/swer2',{
            cancelToken: new CancelToken(function executor(c) {
                // An executor function receives a cancel function as a parameter
                cancel = c;
            })
        ...
        // current transaction
        Axios.get('api/current_trans/swer2',{
            cancelToken: new CancelToken(function executor(c) {
                // An executor function receives a cancel function as a parameter
                cancel = c;
            })
                    ...
                    <main className="liveTrend">
                        <div className="row padding-all-15 no-padding">
                            <div className="col s12 no-padding header-banner">
                                <DashBoardBanner title={"LIVE TRENDS SWER2"} cut_off={this.state.cutoff}/>
                            </div>
...
export default LiveTrendsSwer2;