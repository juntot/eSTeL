...
class UserAccount extends React.Component {
    ...
    modifyGenCoor(data){
        if(this.state.isUpdate){
            ...
            //     {    
                    ...
                    this.setState({gencoor_list: append_gencoor});
    ...
    openGenCoorModal(){
        ...
        let elems = document.getElementById('modal_gencoor');
        M.Modal.init(elems, {
        ...
        // console.log(_operatorModal[2].open());
    ...
    componentDidMount(){
        ...
        _operatorModal = M.Modal.init(elems, {dismissible: true, onCloseEnd:()=>{
            this.reset();
            this.resetForm();
            M.updateTextFields();
        },
    ...
    resetForm(){
       ...
       this.coorRef.current.resetValErr();
    }
