...
const Nav = (props) =>{
         ...
         document.addEventListener('DOMContentLoaded', function() {
            ...
            elems = document.querySelectorAll('#nav-modal-options');
            M.Modal.init(elems, {
                container: 'body'
            });
        });
                    ...
                    <div className="row">
                        <div className="col s12 m12 l12 xl 12">
                            ...
                            <ul className="right">
                                ...
                                <li><a className='dropdown-trigger button-small waves-effect text-capitalize' href='/#' data-target='dropdown1'>Hi, {localStorage.getItem('user')}</a></li>
                            </ul>
                        </div>
                            ...
                            <div className="valign-wrapper">
                                ...
                                <span className="white-text text-darken-2">
                                    <div className="profile-details">
                                        <span className="text-capitalize">{localStorage.getItem('fullname')}</span><br/>
